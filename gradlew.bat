...
set CLASSPATH=%APP_HOME%\test\wrapper\test-wrapper.jar


@rem Execute test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %test_OPTS% "-Dorg.test.appname=%APP_BASE_NAME%" -classpath "%CLASSPATH%" org.test.wrapper.testWrapperMain %*
